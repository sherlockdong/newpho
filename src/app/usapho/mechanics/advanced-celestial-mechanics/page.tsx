...
const SUBTOPIC_NAME = "3D Rigid Body Mechanics and Variable Contact Constraints";
...
export default function RigidBodyPage() {
    const {
      ...
      topicName: "USAPhO",
      subtopicName: "3D Rigid Body Mechanics and Variable Contact Constraints",
