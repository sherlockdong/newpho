...
const SUBTOPIC_NAME = "Resistive Media and Differential Trajectories";
...
export default function DifferentialDragPage() {
    const {
      overrideText,
      setOverrideText,
      questionCount,
      ...
      topicName: "USAPhO",
      subtopicName: "Resistive Media and Differential Trajectories",
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Rigid Body Problems</p>
