...
const NODE_ID = 'USA-18';
const DIFFICULTY_LEVEL = "USAPhO relativity physics competition"; const SAMPLE_PROBLEMS = String.raw`plug in Question A3 (Quantum Foundations)
A particle of mass m is confined to move in a one-dimensional potential well defined by:
V(x) = 0 for 0 <= x <= L
V(x) = +infinity elsewhere

According to de Broglie’s hypothesis, the matter wave associated with the particle must form standing waves inside the well such that the probability density vanishes at the hard walls (x = 0 and x = L).

a. Derive the allowed quantized energy levels E_n of the particle in terms of n, m, L, and Planck's constant h.
b. Suppose the particle is an electron initially in the n = 3 state. It drops to the n = 1 ground state by emitting a single photon. Find the frequency ν of the emitted photon in terms of m, L, and fundamental constants.
c. Consider a semi-classical approximation where a localized photon beam of intensity I and wavelength λ strikes a metallic surface of work function W (where h*c/λ > W) inside a vacuum tube. If the maximum kinetic energy of the ejected photoelectrons matches the ground-state energy E_1 of the particle in the well, find an expression for the required well length L in terms of W, λ, m, and fundamental constants.
d. According to the Heisenberg uncertainty principle, the product of the uncertainties in position and momentum satisfies Δx * Δp >= hbar/2. If we approximate the uncertainty in the particle's position Δx as the width of the well L, find the minimum kinetic energy of the particle predicted by the uncertainty principle and express it as a fraction of the exact quantum ground-state energy E_1.`
...
const SUBTOPIC_NAME = "Quantum Mechanics, Photons, and Atomic Structure";
    ...
    return (
        <main className={`page-wrapper ${styles.pageWrapper}`}>
            <div className={styles.inner}>
                ...
                Quantum Mechanics, Photons, and Atomic Structure
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Quantum, Photons, and Atomics</p>
