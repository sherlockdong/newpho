...
const PAST_PROBLEMS =
    [
        {
            "id": "USA_24_P01",
            "title": "USAPhO 2020 Problem B2",
            "desc": "The problem focuses on wave optics and thin-film interference principles, analyzing the path length differences, phase shifts ($180^{\\circ}$ reflection inversion), and geometric fringe distributions on surrounding boundary walls produced by an off-set point source.",
            "url": "https://aapt.org/physicsteam/2020/upload/2020_USAPhO_Solutions.pdf",
            "type": "Problem"
        },
        {
            "id": "USA_24_P02",
            "title": "USAPhO 2025 Problem B3",
            "desc": "The problem focuses on physical optics and cavity resonators, evaluating longitudinal standing wave configurations, boundary phase restrictions, and the discrete frequency spectra transitions (${\\Delta}\\omega$) inside a Fabry–Pérot interferometer.",
...
const SUBTOPIC_NAME = "Wave Optics, Interference, and Diffraction Regimes";
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Wave Optics</p>
