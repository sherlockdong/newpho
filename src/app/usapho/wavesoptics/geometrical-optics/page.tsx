...
const PAST_PROBLEMS = [
    {
        ...
        "desc": "The problem focuses on geometrical optics of spherical drops (rainbow caustics), requiring an derivation of net deflection angles as a function of the normalized impact parameter $x = b/r$ using Snell's law and internal reflection constraints.",
        "url": "https://aapt.org/physicsteam/upload/2022-USAPhO-Exam.pdf",
        "type": "Problem"
    },
    {
        "id": "USA_23_P02",
        "title": "USAPhO 2024 Problem A3",
        "desc": "The problem focuses on advanced lens mechanics, requiring analytical expressions for longitudinal and transverse magnification factors alongside an evaluation of image geometric blur, diffraction limits, and photon shot noise statistics.",
        "url": "https://aapt.org/physicsteam/upload/USAPhO_Exam_24.pdf",
        "type": "Problem"
    },
    {
        "id": "USA_23_P03",
        "title": "USAPhO 2026 Problem A1",
        "desc": "The problem focuses on optical power adaptations and resolution metrics, examining thin-lens focal scaling configurations for corrective optics alongside an analysis of the diffraction-limited Airy disk intensity parameters at the sensor.",
        "url": "https://aapt.org/physicsteam/2026/upload/2026-USAPhO.pdf",
        "type": "Problem"
    }
]
const PHYSICS_FACTS = [
...
const SUBTOPIC_NAME = "Geometrical Optics and Optical Instrument Matrix Analysis";
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Geometrical Optics</p>
