...
const PAST_PROBLEMS = [
    {
        id: "USA_17_P01",
        title: "AAPT Semifinals 2011 Problem A1",
        desc: "The problem focuses on the adiabatic expansion of a diatomic gas inside a cylinder, utilizing thermodynamics work integrals ($PV^{\gamma} = C$) and calorimetry concepts to find the maximum kinetic energy transfer.",
        url: "https://www.aapt.org/Common/upload/USAPhO-2011_rev-4012021.pdf",
        type: "Problem"
    },
    {
        id: "USA_17_P02",
        title: "USAPhO 2015 Problem A2",
        desc: "The problem focuses on kinetic theory and statistical transport, modeling the effusion and molecular transport of an ideal gas through a small aperture under varying thermal and pressure gradients.",
        url: "https://www.aapt.org/physicsteam/2015/upload/E3-2-5.pdf",
        type: "Problem"
    }
]
...
const SUBTOPIC_NAME = "Kinetic Theory, Statistical Transport, and Calorimetry";
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Kinetic Theory Gases</p>
