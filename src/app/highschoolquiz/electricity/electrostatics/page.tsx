...
const STUDY_RESOURCES = [
  {
    id: "REF_01",
    title: "The Physics Classroom: Static Electricity",
    desc: "Two comprehensive lessons that will you have a basic understanding of the topic.",
    url: "https://www.physicsclassroom.com/tutorial/static-electricity",
    type: "Lessons",
  }, {
    id: "REF_02",
    title: "The Physics Classroom: Interactive Static Electricity",
    desc: "Learn about the law that governs the force acting between charged objects with the Coulomb's Law Interactive.",
    url: "https://www.physicsclassroom.com/Interactive/Static-Electricity",
    type: "Interactive",
  },
  {
    id: "REF_03",
    title: "Khan Academy: Four",
    desc: "Step-by-step video lecture explaining electrostatics.",
    url: "https://www.khanacademy.org/science/highschool-physics/x6679aa2c65c01e53:electrostatics",
    type: "Video",
  },
  {
    id: "REF_04",
    title: "Flipping Physics: Unit 10",
    desc: "Several videoes and a Kahoot that help you understand this topic faster. ",
    url: "http://www.flippingphysics.com/ap-physics-2.html#unit10",
    type: "Lectures",
  }, {
    id: "REF_05",
    title: "Organic Chemistry Tutor: Coulomb's Law",
    desc: "Net Electric Force and Point Charges introduction",
    url: "https://www.youtube.com/watch?v=kCp5yYjo9zE&pp=ygUmb3JnYW5pYyBjaGVtaXN0cnkgdHV0b3IgZWxlY3Ryb3N0YXRpY3PSBwkJPwsBhyohjO8%3D",
    type: "Video",
  }, {
    id: "REF_06",
    title: "Organic Chemistry Tutor: Electric Flux, Gauss's Law & Electric Fields",
    desc: "The video explains the relationship between electric flux and gauss's law.",
...
const SUBTOPIC_NAME = "Electrostatics";
...
${overrideText ? `\nCRITICAL USER OVERRIDE INSTRUCTIONS: "${overrideText}"\n` : "\nVary the conceptual difficulty appropriately to test core knowledge of electrostatics.\n"}
          ...
          >
            <div className={styles.terminalLeft}>
              <div>
                ...
                <p className={styles.terminalSubtitle}>Electrostatics</p>
