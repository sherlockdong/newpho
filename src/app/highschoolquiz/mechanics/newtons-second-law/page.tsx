...
function buildQuizPrompt({
  ...
  return `You are an expert physics professor generating a diagnostic quiz. 
Generate exactly ${questionCount} multiple-choice parsedQuestions specifically focusing on: "${subtopicName}".
