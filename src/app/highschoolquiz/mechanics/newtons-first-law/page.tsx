...
const STUDY_RESOURCES = [
  {
    id: "REF_01",
    title: "The Physics Classroom: Inertia",
  ...
  {
    id: "REF_02",
    title: "Khan Academy: Newton's First Law",
  ...
  return (
    <main className={`page-wrapper ${styles.pageWrapper}`}>
      <div className={styles.inner}>
        ...
        {/* Breadcrumb */}
        <Link href="/highschool/mechanics" className={styles.breadcrumb}>
<svg 
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
        ...
        <div className={styles.protocolsSection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>Pre-Flight Study Protocols</h2>
