...
const SAMPLE_PROBLEMS = "36. Light is refracted when it passes from air into glass. Which of these wave properties changes?\n\n(A) Speed only\n(B) Wavelength only\n(C) Frequency only\n(D) Both speed and wavelength  ← CORRECT\n(E) Both speed and frequency\n\nSolution:\nWhen any wave undergoes refraction by passing from one optical medium into another:\n1. **Frequency ($f$) remains constant:** The frequency of a wave is determined strictly by its source. As wave crests arrive at the boundary interface, they must pass through at the same rate they arrive; energy cannot accumulate at the barrier boundary.\n2. **Speed ($v$) changes:** Glass has a higher index of refraction ($n_{\\text{glass}} > n_{\\text{air}}$) than air. The speed of light decreases inside glass according to $v = \\frac{c}{n}$.\n3. **Wavelength ($\\lambda$) changes:** From the universal wave equation ($v = f\\lambda$), since the speed $v$ decreases while the frequency $f$ stays identical, the wavelength $\\lambda$ must decrease proportionally.\n\nThus, both the speed and the wavelength change during refraction.\n\nTherefore, the correct choice is (D).";
...
const SUBTOPIC_NAME = "Waves and Geometric Optics";
...
export default function WandOPage() {
  const {
    ...
    subtopicName: "Waves and Geometric Optics",
          ...
          >
            <div className={styles.terminalLeft}>
              <div>
                ...
                <p className={styles.terminalSubtitle}>Waves and Geometric Optics</p>
