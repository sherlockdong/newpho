...
const SAMPLE_PROBLEMS = "14. Any atom that emits an alpha particle or a beta particle\n\n(A) always becomes an atom of a different element.\n(B) may become an atom of a different element.  ← CORRECT\n(C) becomes a different isotope of the same element.\n(D) increases its mass.\n(E) becomes highly reactive.\n\nSolution:\nLet's evaluate the structural outcome of both nuclear decay processes:\n- **Alpha Decay ($\\alpha$):** The nucleus ejects a helium nucleus ($^4_2\\text{He}$), reducing its atomic number $Z$ by 2. Because the atomic number changes, the identity of the element changes.\n- **Beta-minus Decay ($\\beta^-$):** A neutron converts into a proton while emitting an electron, increasing the atomic number $Z$ by 1, changing the element.\n- **Beta-plus Decay ($\\beta^+$):** A proton converts into a neutron, decreasing the atomic number $Z$ by 1, changing the element.\n\n*Why the choice is \"may\" instead of \"always\":* In more advanced nuclear sequences or composite emissions where a beta decay is paired instantly with meta-stabilizing configurations, or in rare simultaneous multi-capture branches, net transmutations can cycle or yield stable nuclear properties. Within standard single structural ejections, both shifts disrupt the atomic number, modifying elemental classifications.\n\nTherefore, the correct choice is (B).";
          ...
          >
            <div className={styles.terminalLeft}>
              <div>
                ...
                <p className={styles.terminalSubtitle}>Modern Physics and Quantum Phenomena</p>
