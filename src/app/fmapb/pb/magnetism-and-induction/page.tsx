...
const SAMPLE_PROBLEMS = "49. A circuit consists of a resistor, capacitor, and inductor connected in series to an AC source. As the source frequency increases, the current in the circuit decreases. Which statement about the circuit is NOT correct as the source frequency increases?\n\n(A) The impedance of the circuit increases.\n(B) The circuit is said to become more capacitive than inductive.  ← CORRECT\n(C) The phase angle for the circuit becomes more positive.\n(D) The inductive reactance increases.\n(E) The total power from the source decreases\n\nSolution:\nLet's analyze the behavior of an RLC series AC circuit under an escalating frequency $\\omega$.\n\n1. **Reactable Properties:**\n   - Inductive Reactance ($X_L = \\omega L$) scales linearly with frequency. As $\\omega$ increases, $X_L$ increases, confirming statement (D) is true.\n   - Capacitive Reactance ($X_C = \\frac{1}{\\omega C}$) is inversely proportional to frequency. As $\\omega$ increases, $X_C$ drops toward zero.\n\n2. **Evaluating Statement (B):**\n   As frequency goes up, $X_L$ increases and $X_C$ decreases. Therefore, the circuit becomes dominated by inductance, making it *more inductive*, not capacitive. This makes Statement (B) fundamentally incorrect.\n\n3. **Verifying other conditions:**\n   - Since $X_L > X_C$, the total impedance $Z = \\sqrt{R^2 + (X_L - X_C)^2}$ increases, matching the prompt's condition that current decreases ($I = \\frac{V}{Z}$), confirming (A).\n   - The phase angle $\\phi = \\tan^{-1}\\left(\\frac{X_L - X_C}{R}\\right)$ becomes larger and more positive since the numerator is rising, confirming (C).\n   - Power $P = I^2 R$ drops because current is falling, confirming (E).\n\nTherefore, the correct choice is (B).";
...
const SUBTOPIC_NAME = "Magnetism and Electromagnetic Induction";
...
export default function FluidMechanicsPage() {
  const {
    ...
    subtopicName: "Magnetism and Electromagnetic Induction",
          ...
          >
            <div className={styles.terminalLeft}>
              <div>
                ...
                <p className={styles.terminalSubtitle}>Magnetism and Induction</p>
