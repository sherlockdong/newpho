...
const NODE_ID = 'FMA-09';
const DIFFICULTY_LEVEL = "F=MA physics competition";
const SAMPLE_PROBLEMS = "19. A helicopter is flying horizontally at constant speed to the right. A perfectly flexible uniform cable is suspended beneath the helicopter; air friction on the cable is not negligence.\n\nWhich of the following descriptions best shows the shape of the cable as the helicopter flies through the air?\n\n(A) The cable hangs perfectly straight and completely vertical beneath the helicopter.\n(B) The cable hangs in a straight diagonal line, tilted backward away from the direction of motion.  ← CORRECT\n(C) The cable curves backward away from the direction of motion, with its slope becoming increasingly shallow toward the bottom tip.\n(D) The cable curves backward away from the direction of motion, with its slope becoming increasingly steep toward the bottom tip.\n(E) The cable hangs with an S-shaped curve as it experiences complex aerodynamic drag forces.\n\nSolution:\nTo determine the physical shape of the flexible cable, let's look at the balance of forces acting on any arbitrary section of the cable measuring from the bottom free end up to a point at a distance $s$ along its length.\n\n1. **Forces acting on a segment of length $s$:**\n   - **Gravity (Downward):** The weight of this section scales linearly with its length, $W(s) = \\lambda s g$, where $\\lambda$ is the uniform mass per unit length.\n   - **Air Resistance / Drag (Horizontal):** Since the helicopter is moving at a constant horizontal velocity relative to the air, the cable experiences a uniform air friction or drag force acting in the direction opposite to the motion (to the left). This horizontal drag force is also directly proportional to the length of the segment exposed to the airflow: $D(s) = \\gamma s$, where $\\gamma$ is the drag force per unit length.\n   - **Tension (Along the Cable):** The tension force $\\vec{T}(s)$ from the upper section of the cable must perfectly balance both the downward weight and the backward drag of the segment below it because the cable is moving at a constant, non-accelerating velocity.\n\n2. **Analyzing the Angle of the Cable:**\n   Let $\\theta(s)$ be the angle that the cable makes with the vertical at any given point. Balancing the forces yields:\n   - Vertical balance: $T(s) \\cos\\theta(s) = W(s) = \\lambda s g$\n   - Horizontal balance: $T(s) \\sin\\theta(s) = D(s) = \\gamma s$\n\n   Dividing the horizontal equilibrium equation by the vertical equilibrium equation eliminates both the tension $T(s)$ and the structural segment length $s$:\n   $$\\tan\\theta(s) = \\frac{D(s)}{W(s)} = \\frac{\\gamma s}{\\lambda s g} = \\frac{\\gamma}{\\lambda g}$$\n\n3. **Conclusion:**\n   Because both $\\gamma$ (drag per unit length) and $\\lambda g$ (weight per unit length) are constants, the ratio $\\tan\\theta$ is completely independent of the position along the cable ($s$). A constant angle $\\theta$ means that the cable does not bend or curve; it hangs in a perfectly straight diagonal line, tilted backward away from the direction of flight.\n\nTherefore, the correct choice is (B).";
...
const SUBTOPIC_NAME = "Non-Conservative Force and Resistive Media";
...
export default function ResistiveForcepage() {
    const {
      overrideText,
      setOverrideText,
      questionCount,
      ...
      topicName: "F=ma",
      subtopicName: "Non-Conservative Force and Resistive Media",
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>Resistive Forces</p>
