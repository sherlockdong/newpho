...
const NODE_ID = 'FMA-05';
const DIFFICULTY_LEVEL = "F=MA physics competition";
const SAMPLE_PROBLEMS = "A small ball of mass $3m$ is at rest on the ground. A second small ball of mass $m$ is positioned above the ground by a vertical massless rod of length $L$ that is also attached to the ball on the ground. The original orientation of the rod is directly vertical, and the top ball is given a small horizontal nudge. There is no friction; assume that everything happens in a single plane.\n\n21. Determine the horizontal displacement $x$ of the second ball just before it hits the ground.\n\n(A) $x = \\frac{3}{4}L$  ← CORRECT\n(B) $x = \\frac{3}{5}L$\n(C) $x = \\frac{1}{4}L$\n(D) $x = \\frac{1}{3}L$\n(E) $x = \\frac{2}{5}L$\n\nSolution:\nTo solve this problem efficiently, we look at the system's external forces in the horizontal direction.\n\n1. **Horizontal Forces and Center of Mass ($x_{\\text{cm}}$):**\n   Because the ground is frictionless and there are no other external horizontal forces acting on the two-ball system, the total linear momentum in the horizontal direction must be conserved. Since the system starts from rest, the horizontal position of the center of mass ($x_{\\text{cm}}$) cannot move and must remain constant throughout the entire motion.\n\n2. **Setting Up the Coordinate System:**\n   Let the initial horizontal position of the bottom ball ($3m$) be $x_1 = 0$. \n   Since the rod is perfectly vertical initially, the top ball ($m$) also has an initial horizontal position of $x_2 = 0$.\n   Therefore, the initial horizontal center of mass is:\n   $$x_{\\text{cm}} = \\frac{(3m)(0) + (m)(0)}{3m + m} = 0$$\n\n3. **Final Position Analysis:**\n   Just before the top ball hits the ground, the rod of length $L$ will be lying flat, completely horizontal on the ground. Let the final horizontal position of the bottom ball be $x_1'$ and the final horizontal position of the top ball be $x_2'$.\n\n   Since the rod has a fixed length $L$, the distance between the two balls is $L$:\n   $$x_2' - x_1' = L \\implies x_1' = x_2' - L$$\n\n4. **Applying Center of Mass Conservation:**\n   Because $x_{\\text{cm}}$ must still equal $0$:\n   $$\\frac{3m(x_1') + m(x_2')}{3m + m} = 0$$\n   $$3m(x_1') + m(x_2') = 0$$\n\n   Substitute $x_1' = x_2' - L$ into the equation:\n   $$3m(x_2' - L) + m(x_2') = 0$$\n   $$3x_2' - 3L + x_2' = 0$$\n   $$4x_2' = 3L$$\n   $$x_2' = \\frac{3}{4}L$$\n\nSince the top ball started at $x_2 = 0$, its total horizontal displacement is simply $x = x_2' - 0 = \\frac{3}{4}L$.\n\nTherefore, the correct choice is (A).";
...
const SUBTOPIC_NAME = "System of Particles and Center of Mass";
...
export default function SystemMassPage() {
    const {
      overrideText,
      setOverrideText,
      questionCount,
      ...
      topicName: "F=ma",
      subtopicName: "System of Particles and Center of Mass",
                    ...
                    >
                        <div className={styles.terminalLeft}>
                            <div>
                                ...
                                <p className={styles.terminalSubtitle}>System of Particles and Center of Mass</p>
